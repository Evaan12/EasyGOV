...
namespace Application.Features.Roles.Commands
{
    public class UpdateRoleCommandHandler : IRequestHandler<UpdateRoleCommand, Unit>
    {
        ...
        public UpdateRoleCommandHandler(IRoleService roleService, ICurrentUserService currentUserService, ITenantService tenantService)
        {
        ...
        public async Task<Unit> Handle(UpdateRoleCommand request, CancellationToken cancellationToken)
        {
            ...
            if (role.IsDefault)
                throw new DomainException("Cannot modify a default system role.");
            ...
            await _roleService.UpdateRoleAsync(request.RoleId, request.Name, cancellationToken);
            return Unit.Value;
        }
    }
}